    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('good_conduct', models.FileField(upload_to=accounts.models.user_documents_path)),
                ('certificates', models.FileField(upload_to=accounts.models.user_documents_path)),
                ('id_front', models.ImageField(upload_to=accounts.models.user_id_path)),
                ('id_back', models.ImageField(upload_to=accounts.models.user_id_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(blank=True, default='profile/profile.png', null=True, upload_to=accounts.models.user_profile_path)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
